                ...
                <tbody>
                    @foreach ($DSslide as $slide)
                        <tr>
                            ...
                            <td class="center">
                                <a href="/admin/slide/sua/{{ $slide->id }}" style="color: #337ab7"><i class="fa fa-pencil fa-fw"></i></a>
                                <a href="/admin/slide/xoa/{{ $slide->id }}" style="color: red"><i class="fa fa-trash-o  fa-fw"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
